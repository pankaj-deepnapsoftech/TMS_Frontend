...
const Registrations = () => {
    ...
    const { PostUserData } = useAuthContext()
                ...
                <div className="backdrop-blur-lg bg-white/10 border border-white/20 rounded-xl shadow-xl p-8 w-full h-[70%] flex flex-col justify-center max-w-[30rem]">
                    ...
                    <form className="space-y-5" onSubmit={formik.handleSubmit} autoComplete="off">
                        ...
                        <div className="relative">
                            <label className="block text-sm text-white font-medium mb-1" htmlFor="name">
                                Full Name
                            </label>
                            <input
                                id="name"
                            ...
                            {formik.touched.name && formik.errors.name && (
                                <p className="text-sm text-red-400 mt-1">{formik.errors.name}</p>
                            )}
                        </div>

                       
                        <div className="relative">
                            <label className="block text-sm text-white font-medium mb-1" htmlFor="email">
                                Email
                            </label>
                            <input
                                id="email"
                        ...
                        <div className="relative">
                            <label className="block text-sm text-white font-medium mb-1" htmlFor="password">
                                Password
                            </label>
                            <input
                                id="password"
                        ...
                        <div className="relative">
                            <label className="block text-sm text-white font-medium mb-1" htmlFor="confirmPassword">
                                Confirm Password
                            </label>
                            <input
                                id="confirmPassword"
                            ...
                            {confirmError && <p className="text-sm text-red-400 mt-1">{confirmError}</p>}
                        </div>
                        <div className="relative">
                            <label className="block text-sm text-white font-medium mb-1" htmlFor="department">
                                Department
                            </label>
                            <select
                                id="department"
